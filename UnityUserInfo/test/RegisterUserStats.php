...
$sql = "SELECT username FROM logininfo WHERE username = '" . $loginId . "'";
...
if ($result->num_rows > 0) {
    ...
    $sql3 = "INSERT INTO logininfo (playerstats, playername, password) VALUES ('" . $loginName . "', '" . $loginId . "','" . $loginPass . "')";
